...
export const HOME_SECTION_RULE = DNA_SECTION_RULE;

export const HOME_SECTION = DNA_HOME_SECTION;
export const HOME_SECTION_HEADING = DNA_HOME_SECTION_HEADING;
