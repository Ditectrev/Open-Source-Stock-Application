/**
 * GET /api/market/etfs
 * Returns ETF performance data grouped by category
...
export async function GET(request: NextRequest) {
  try {
    ...
    const data = await marketDataService.getETFPerformance(period);
    ...
    logger.error("Failed to fetch ETF performance", error as Error);
