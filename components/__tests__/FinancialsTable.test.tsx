...
describe("FinancialsTable", () => {
  ...
  describe("Tooltip Functionality", () => {
    it("should show tooltip on hover over Key Financial Facts heading", () => {
      ...
      expect(screen.getByText(/Core financial figures that summarize/)).toBeInTheDocument();
    });
    ...
    it("should show tooltip on hover over Valuation Metrics heading", () => {
      ...
      const hoverTarget = heading.closest("div")!;
      fireEvent.mouseEnter(hoverTarget);
      expect(screen.getByText(/Ratios that help assess whether a stock/)).toBeInTheDocument();
    });
    ...
    it("should show tooltip on hover over Growth Metrics heading", () => {
      ...
      const hoverTarget = heading.closest("div")!;
      fireEvent.mouseEnter(hoverTarget);
      expect(screen.getByText(/Measures of how quickly the company/)).toBeInTheDocument();
    });
    ...
    it("should show tooltip on hover over Profitability Metrics heading", () => {
      ...
      const hoverTarget = heading.closest("div")!;
      fireEvent.mouseEnter(hoverTarget);
      expect(screen.getByText(/Ratios that measure how effectively/)).toBeInTheDocument();
    });
    ...
    it("should hide section tooltip on mouse leave", () => {
      ...
      expect(screen.queryByText(/Core financial figures that summarize/)).not.toBeInTheDocument();
    });

    it("should show tooltip on hover over Revenue metric label", () => {
      renderWithTheme(mockFinancials);
      const label = screen.getByText("Revenue");
      const hoverTarget = label.closest("div")!;
      fireEvent.mouseEnter(hoverTarget);
      expect(screen.getByText(/Total revenue generated by the company/)).toBeInTheDocument();
    });

    it("should show tooltip on hover over P/E Ratio metric label", () => {
      renderWithTheme(mockFinancials);
      const label = screen.getByText("P/E Ratio");
      const hoverTarget = label.closest("div")!;
      fireEvent.mouseEnter(hoverTarget);
      expect(screen.getByText(/Price-to-Earnings ratio compares/)).toBeInTheDocument();
    });
    ...
    it("should hide metric tooltip on mouse leave", () => {
      ...
      expect(screen.getByText(/Total revenue generated by the company/)).toBeInTheDocument();
      fireEvent.mouseLeave(hoverTarget);
      expect(screen.queryByText(/Total revenue generated by the company/)).not.toBeInTheDocument();
    });
  });
