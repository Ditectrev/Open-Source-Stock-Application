...
console.log(
  "3. Or test manually: curl http://localhost:3000/api/market/symbol/AAPL\n"
);

console.log(
  "\x1b[33mNote: API tests will fail without proper external API access.\x1b[0m"
);
console.log(
  "\x1b[33mThis is expected in a local development environment.\x1b[0m\n"
);
